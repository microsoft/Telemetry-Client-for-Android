...
/**
 * Data contract class HelloWorldC.
 */
public class HelloWorldC extends Base implements
    IJsonSerializable
{
    /**
    ...
    /**
     * Initializes a new instance of the <see cref="HelloWorldC"/> class.
     */
    public HelloWorldC()
    {
    ...
    public void SetupAttributes()
    {
        ...
        this.Attributes.put("Description", "Hello World Part C Schema");
    }
    ...
    protected void InitializeFields() {
        QualifiedName = "Microsoft.Example.HelloWorldC";
    }
}
